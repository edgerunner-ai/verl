...
try:
    ...
    _fsdp_wrapper_names = (DDP, Float16Module, MegatronFSDP)
    try:
        ...
        _fsdp_wrapper_names = _fsdp_wrapper_names + (FullyShardedDataParallelV1, FullyShardedDataParallelV2)
    except ImportError:
        pass
    ALL_MODULE_WRAPPER_CLASSNAMES = _fsdp_wrapper_names
except ImportError:
...
def _megatron_fsdp_wrapper_types():
    """Type-check Megatron-FSDP wrappers. ``FullyShardedDataParallel`` is a factory."""
    types = []
    try:
        from megatron.core.distributed.fsdp.src.megatron_fsdp.megatron_fsdp import MegatronFSDP
